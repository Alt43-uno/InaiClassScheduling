...
class HtmlOutput:
    ...
    def getResult(solution):
        ...
        sb = ["<br><br><div class=\"container\"><h1>INAI Class Scheduling <br>Welcome! </h1><br><link href=\"/static/css/bootstrap.min.css\" rel=\"stylesheet\" integrity=\"sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3\" crossorigin=\"anonymous\"><form class=\"d-flex\" method=\"get\" action=\"{% url 'create' %}\"><input name=\"q\"  value=\"create\" hidden><button class=\"btn btn-outline-success\" type=\"submit\">Generate</button></form><a class=\"btn btn-outline-danger\" href=\"http://127.0.0.1:8000/admin/\" type=\"submit\">Admin</a><br><br>",]
            ...
            for periodId in range(HtmlOutput.ROOM_ROW_NUMBER):
                if periodId == 0:
                    ...
                    for dayId in range(HtmlOutput.ROOM_COLUMN_NUMBER):
                        if dayId == 0:
                            sb.append("<th style='text-align: center; border: 1px solid black; padding: 5px' scope='row' colspan='2'>")
    ...
    def getTableHeader(room):
        sb = ["<tr><th style='text-align: center;padding: 10px;border: 1px solid black' scope='col' colspan='2'> Room: ", room.Name, "</th>\n"]
        for weekDay in HtmlOutput.WEEK_DAYS:
            sb.append("<th style='text-align: center; border: 1px solid black; padding: 5px; width: 15%' scope='col' rowspan='2'>")
            sb.append(weekDay)
            sb.append("</th>\n")
        sb.append("</tr>\n")
        sb.append("<tr>\n")
        sb.append("</th>\n")
        sb.append("<th style='padding: 10px;text-align: center; border: 1px solid black; padding: 5px'>Seats: ")
